                ...
                <ButtonGroup>
                  ...
                  >
                    <MenuItem eventKey="1" onClick={() => {
                      ...
                      return (
                        props.filterNames.indexOf('timeShort') === -1 ?
                          props.setFilter('timeShort') :
                          props.removeFilter('timeShort')
                      )
                    }}
                    >
                    ...
                    <MenuItem eventKey="2" onClick={() => {
                      ...
                      props.removeFilter('timeLong');
                      return (
                        props.filterNames.indexOf('timeMedium') === -1 ?
                          props.setFilter('timeMedium') :
                          props.removeFilter('timeMedium')
                      )
                    }}
                    >
                    ...
                    <MenuItem eventKey="3" onClick={() => {
                      ...
                      props.removeFilter('timeLong');
                      return (
                        props.filterNames.indexOf('timeLong') === -1 ?
                          props.setFilter('timeLong') :
                          props.removeFilter('timeLong')
                      )
                    }}
                    >
                  ...
                  >
                    ...
                    <MenuItem eventKey="1" onClick={() => {
                      ...
                      return (
                        props.filterNames.indexOf('difficultEase') === -1 ?
                          props.setFilter('difficultEase') :
                          props.removeFilter('difficultEase')
                      )
                    }}
                    >
                    ...
                    <MenuItem eventKey="2" onClick={() => {
                      ...
                      props.removeFilter('difficultHard');
                      return (
                        props.filterNames.indexOf('difficultMedium') === -1 ?
                          props.setFilter('difficultMedium') :
                          props.removeFilter('difficultMedium')
                      )
                    }}
                    >
                    ...
                    <MenuItem eventKey="3" onClick={() => {
                      ...
                      props.removeFilter('difficultHard');
                      return (
                        props.filterNames.indexOf('difficultHard') === -1 ?
                          props.setFilter('difficultHard') :
                          props.removeFilter('difficultHard')
                      )
                    }}
                    >
